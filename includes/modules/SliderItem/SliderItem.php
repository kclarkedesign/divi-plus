...
require_once get_template_directory().'/includes/builder/module/helpers/Slider.php';
	...
	function init() {
		...
		$this->settings_modal_toggles = array(
			'general'    => array(
				'toggles' => array(
					...
					'image_video'  => esc_html__( 'Image & Video', 'dvpls-divi-plus' ),
					'player_pause' => esc_html__( 'Player Pause', 'dvpls-divi-plus' ),
					'admin_label'  => array(
			...
			'advanced'   => array(
				'toggles' => array(
					...
					'navigation' => esc_html__( 'Navigation', 'dvpls-divi-plus' ),
					'image'      => array(
			...
			'custom_css' => array(
				'toggles' => array(
					'attributes' => array(
						'title'    => esc_html__( 'Attributes', 'dvpls-divi-plus' ),
						'priority' => 95,
					),
				),
			),
		...
		$this->advanced_fields = array(
			...
			'box_shadow'      => array(
				'default' => false,
				'image'   => array(
					'label'             => esc_html__( 'Image Box Shadow', 'dvpls-divi-plus' ),
			...
			'max_width'       => array(
				...
				'options'              => array(
					'width'     => array(
						'label' => esc_html__( 'Content Width', 'dvpls-divi-plus' ),
					),
					'max_width' => array(
						'label' => esc_html__( 'Content Max Width', 'dvpls-divi-plus' ),
					),
				),
			),
			'height'          => false,
		...
		$this->custom_css_fields = array(
			'slide_title'       => array(
				'label'    => esc_html__( 'Slide Title', 'dvpls-divi-plus' ),
				'selector' => '.et_pb_slide_description .et_pb_slide_title',
			),
			'slide_container'   => array(
				'label'    => esc_html__( 'Slide Description Container', 'dvpls-divi-plus' ),
				'selector' => '.et_pb_container',
			),
			'slide_description' => array(
				'label'    => esc_html__( 'Slide Description', 'dvpls-divi-plus' ),
				'selector' => '.et_pb_slide_description',
			),
			'slide_button'      => array(
				'label'                    => esc_html__( 'Slide Button', 'dvpls-divi-plus' ),
				'selector'                 => '.et_pb_slide .et_pb_container a.et_pb_more_button.et_pb_button',
				'no_space_before_selector' => true,
			),
			'slide_image'       => array(
				'label'    => esc_html__( 'Slide Image', 'dvpls-divi-plus' ),
		...
		$this->help_videos = array(
			array(
				'id'   => '-YeoR2xSLOY',
				'name' => esc_html__( 'An introduction to the Slider module', 'dvpls-divi-plus' ),
			),
		);
	}
	...
	function get_fields() {
		$fields = array(
			...
			'button_text'          => array(
				...
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Define the text for the slide button', 'dvpls-divi-plus' ),
				'toggle_slug'     => 'main_content',
				'dynamic_content' => 'text',
				'mobile_options'  => true,
				'hover'           => 'tabs',
			...
			'button_link'          => array(
				'label'            => esc_html__( 'Button Link URL', 'dvpls-divi-plus' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Input a destination URL for the slide button.', 'dvpls-divi-plus' ),
				'toggle_slug'      => 'link_options',
				'default_on_front' => '#',
				'dynamic_content'  => 'url',
			),
			'url_new_window'       => array(
				'label'            => esc_html__( 'Button Link Target', 'dvpls-divi-plus' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => esc_html__( 'In The Same Window', 'dvpls-divi-plus' ),
					'on'  => esc_html__( 'In The New Tab', 'dvpls-divi-plus' ),
				),
				'toggle_slug'      => 'link_options',
				'description'      => esc_html__( 'Here you can choose whether or not your link opens in a new window', 'dvpls-divi-plus' ),
			...
			'image'                => array(
				...
				'choose_text'        => esc_attr__( 'Choose a Slide Image', 'dvpls-divi-plus' ),
				'update_text'        => esc_attr__( 'Set As Slide Image', 'dvpls-divi-plus' ),
				'affects'            => array(
					'image_alt',
				),
				'description'        => esc_html__( 'If defined, this slide image will appear to the left of your slide text. Upload an image, or leave blank for a text-only slide.', 'dvpls-divi-plus' ),
			...
			'use_bg_overlay'       => array(
				'label'            => esc_html__( 'Use Background Overlay', 'dvpls-divi-plus' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
				...
				'tab_slug'         => 'advanced',
				'toggle_slug'      => 'overlay',
				'description'      => esc_html__( 'When enabled, a custom overlay color will be added above your background image and behind your slider content.', 'dvpls-divi-plus' ),
			),
			'bg_overlay_color'     => array(
				'label'           => esc_html__( 'Background Overlay Color', 'dvpls-divi-plus' ),
				'type'            => 'color-alpha',
				'custom_color'    => true,
				'depends_show_if' => 'on',
				'description'     => esc_html__( 'Use the color picker to choose a color for the background overlay.', 'dvpls-divi-plus' ),
				'tab_slug'        => 'advanced',
				'toggle_slug'     => 'overlay',
				'mobile_options'  => true,
				'sticky'          => true,
			...
			'use_text_overlay'     => array(
				'label'            => esc_html__( 'Use Text Overlay', 'dvpls-divi-plus' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => et_builder_i18n( 'No' ),
				...
				'tab_slug'         => 'advanced',
				'toggle_slug'      => 'overlay',
				'description'      => esc_html__( 'When enabled, a background color is added behind the slider text to make it more readable atop background images.', 'dvpls-divi-plus' ),
			),
			'text_overlay_color'   => array(
				'label'           => esc_html__( 'Text Overlay Color', 'dvpls-divi-plus' ),
				'type'            => 'color-alpha',
				'custom_color'    => true,
				'depends_show_if' => 'on',
				'tab_slug'        => 'advanced',
				'toggle_slug'     => 'overlay',
				'description'     => esc_html__( 'Use the color picker to choose a color for the text overlay.', 'dvpls-divi-plus' ),
				'mobile_options'  => true,
				'sticky'          => true,
			),
			'alignment'            => array(
				'label'            => esc_html__( 'Image Alignment', 'dvpls-divi-plus' ),
				'type'             => 'select',
				'option_category'  => 'layout',
				'options'          => array(
				...
				'tab_slug'         => 'advanced',
				'toggle_slug'      => 'image',
				'description'      => esc_html__( 'This setting determines the vertical alignment of your slide image. Your image can either be vertically centered, or aligned to the bottom of your slide.', 'dvpls-divi-plus' ),
			),
			'video_url'            => array(
				'label'              => esc_html__( 'Video', 'dvpls-divi-plus' ),
				'type'               => 'upload',
				'data_type'          => 'video',
				'upload_button_text' => esc_attr__( 'Upload a video', 'dvpls-divi-plus' ),
				'choose_text'        => esc_attr__( 'Choose a Video WEBM File', 'dvpls-divi-plus' ),
				'update_text'        => esc_attr__( 'Set As Video', 'dvpls-divi-plus' ),
				'option_category'    => 'basic_option',
				'description'        => esc_html__( 'If defined, this video will appear to the left of your slide text. Enter youtube or vimeo page url, or leave blank for a text-only slide.', 'dvpls-divi-plus' ),
				'toggle_slug'        => 'image_video',
			...
			'image_alt'            => array(
				'label'           => esc_html__( 'Image Alternative Text', 'dvpls-divi-plus' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'depends_show_if' => 'on',
				'depends_on'      => array(
				...
				'description'     => esc_html__( 'If you have a slide image defined, input your HTML ALT text for the image here.', 'dvpls-divi-plus' ),
				'tab_slug'        => 'custom_css',
				'toggle_slug'     => 'attributes',
				'dynamic_content' => 'text',
			),
			'allow_player_pause'   => array(
				'label'            => esc_html__( 'Pause Video When Another Video Plays', 'dvpls-divi-plus' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => et_builder_i18n( 'No' ),
				...
				'description'      => esc_html__( 'Allow video to be paused by other players when they begin playing', 'dvpls-divi-plus' ),
			),
			'content'              => array(
				'label'           => et_builder_i18n( 'Body' ),
				'type'            => 'tiny_mce',
			...
			'arrows_custom_color'  => array(
				'label'          => esc_html__( 'Arrow Color', 'dvpls-divi-plus' ),
				'description'    => esc_html__( 'Pick a color to use for the slider arrows that are used to navigate through each slide.', 'dvpls-divi-plus' ),
				'type'           => 'color-alpha',
				'custom_color'   => true,
				'tab_slug'       => 'advanced',
			...
			'dot_nav_custom_color' => array(
				'label'          => esc_html__( 'Dot Navigation Color', 'dvpls-divi-plus' ),
				'description'    => esc_html__( 'Pick a color to use for the dot navigation that appears at the bottom of the slider to designate which slide is active.', 'dvpls-divi-plus' ),
				'type'           => 'color-alpha',
				'custom_color'   => true,
				'tab_slug'       => 'advanced',
				'toggle_slug'    => 'navigation',
			...
			'admin_title'          => array(
				...
				'type'        => 'text',
				'description' => esc_html__( 'This will change the label of the slide in the builder for easy identification.', 'dvpls-divi-plus' ),
				'toggle_slug' => 'admin_label',
			),
			'text_border_radius'   => array(
				'label'            => esc_html__( 'Text Overlay Border Radius', 'dvpls-divi-plus' ),
				'description'      => esc_html__( 'Increasing the border radius will increase the roundness of the overlay corners. Setting this value to 0 will result in squared corners.', 'dvpls-divi-plus' ),
				'type'             => 'range',
				'option_category'  => 'layout',
			...
			'__video_embed'        => array(
				'type'                => 'computed',
				'computed_callback'   => array( 'DVPLS_Slider_Item', 'get_video_embed' ),
