...
require_once get_template_directory().'/includes/builder/module/helpers/Slider.php'; // C:\Users\Kirk\Local Sites\marilocal\app\public\wp-content\themes\Divi\includes\builder\module\helpers\Slider.php

class DVPLS_Slider extends ET_Builder_Module {
	function init() {
		$this->name            = esc_html__( 'Ex Slider', 'dvpls-divi-plus' );
		$this->plural          = esc_html__( 'Ex Sliders', 'dvpls-divi-plus' );
		$this->slug            = 'dv_pls_slider';
		$this->vb_support      = 'on';
		$this->child_slug      = 'dv_pls_slide';
		...
		$this->settings_modal_toggles = array(
			...
			'custom_css' => array(
				'toggles' => array(
					'animation' => array(
						'title'    => esc_html__( 'Animation', 'dvpls-divi-plus' ),
						'priority' => 90,
					),
				),
			),
		...
		$this->custom_css_fields = array(
			...
			'slide_controllers'       => array(
				'label'    => esc_html__( 'Slide Controllers', 'dvpls-divi-plus' ),
				'selector' => '.et-pb-controllers',
			),
			'slide_active_controller' => array(
				'label'    => esc_html__( 'Slide Active Controller', 'dvpls-divi-plus' ),
			...
			'slide_arrows'            => array(
				'label'    => esc_html__( 'Slide Arrows', 'dvpls-divi-plus' ),
	...
	function get_fields() {
		$fields = array(
			'show_arrows'             => array(
				'label'            => esc_html__( 'Show Arrows', 'dvpls-divi-plus' ),
				'type'             => 'yes_no_button',
				...
				'description'      => esc_html__( 'This setting will turn on and off the navigation arrows.', 'dvpls-divi-plus' ),
				'mobile_options'   => true,
				'hover'            => 'tabs',
			),
			'show_pagination'         => array(
				'label'            => esc_html__( 'Show Controls', 'dvpls-divi-plus' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'on'  => et_builder_i18n( 'Yes' ),
				...
				'default_on_front' => 'on',
				'toggle_slug'      => 'elements',
				'description'      => esc_html__( 'This setting will turn on and off the circle buttons at the bottom of the slider.', 'dvpls-divi-plus' ),
				'mobile_options'   => true,
				'hover'            => 'tabs',
			),
			'show_content_on_mobile'  => array(
				'label'            => esc_html__( 'Show Content On Mobile', 'dvpls-divi-plus' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'layout',
				'options'          => array(
					'on'  => et_builder_i18n( 'Yes' ),
			...
			'show_cta_on_mobile'      => array(
				'label'            => esc_html__( 'Show CTA On Mobile', 'dvpls-divi-plus' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'layout',
				'options'          => array(
					'on'  => et_builder_i18n( 'Yes' ),
			...
			'show_image_video_mobile' => array(
				'label'            => esc_html__( 'Show Image / Video On Mobile', 'dvpls-divi-plus' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'layout',
				'options'          => array(
					'off' => et_builder_i18n( 'No' ),
